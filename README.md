...
Estruturação de rotas manualmente
...
##
Este projeto foi desenvolvido como um desafio pessoal para:

Entender melhor o funcionamento interno do Node.js
Aprender como frameworks abstraem o tratamento de requisições
Praticar lógica, organização de código e arquitetura básica de APIs

Ao construir tudo manualmente, consegui ter uma visão mais clara de como funciona o fluxo de uma aplicação backend, desde a chegada da requisição até a resposta ao cliente.
